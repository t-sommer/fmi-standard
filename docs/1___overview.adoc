...
Each section starts with a brief description of the mode's purpose, then the mathematical model in a table linking formulas with the C-API functions, and finally descriptions of all allowed functions for this particular state machine mode.
